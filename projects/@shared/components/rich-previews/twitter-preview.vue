  ...
  >
    ...
    >
      ...
      >
        ...
        />
        <div v-if="type === 'player'" class="twitter-preview__player-link">
      ...
      <!-- Image fallback -->
      <div v-else class="twitter-preview__media twitter-preview__media--image-fallback">
      ...
      <div class="twitter-preview__content">
        ...
        <div class="twitter-preview__domain">
          <svg viewBox="0 0 24 24" class="twitter-preview__icon">
            <g>
