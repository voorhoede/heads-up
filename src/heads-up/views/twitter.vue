  ...
  <div>
    <panel-section title="Preview">
      ...
      <figure v-if="isValidCard && isSupportedCard">
        ...
        <figcaption class="twitter__preview-caption">
          Preview based on
          <external-link href="https://mobile.twitter.com/">
            mobile.twitter.com
          </external-link>.
        </figcaption>
      </figure>
    ...
    <panel-section title="Properties">
      <properties-list>
        ...
        <template v-for="username in ['creator', 'site']">
          ...
          >
            <external-link
              :href="`https://twitter.com/${twitter[username].slice(1)}`"
            >
              {{ twitter[username] }}
            </external-link>
          </dd>
    ...
    <panel-section title="Resources">
      <resource-list>
        <li>
          <external-link
            href="https://developer.twitter.com/en/docs/tweets/optimize-with-cards/overview/abouts-cards.html"
          >
            About Twitter cards
          </external-link>
        </li>
